...
(5, "Khóa học đào tạo pha chế chuyên nghiệp", "pha-che-chuyen-nghiep.jpg", 5, 4150000,"Dành cho đối tượng học nghề pha chế để làm việc chuyên nghiệp. Đảm bảo học viên có đủ các kỹ năng tiêu chuẩn để có mức thu nhập cao trong nghề. Đảm bảo việc làm cho học viên sau khi tốt nghiệp." , 2130000, "Từ 8 - 12 " ," tầng 5 – 142 Lê Duẩn, Hà Nội ",1,15,60,3,current_timestamp()),
...
(7, "Khoá học làm Pizza mỳ Ý Pasta", "mon-y.jpg", 2, 2400000,"Khóa học làm Pizza, mỳ Ý, Pasta là khóa học nấu ăn chuyên đề dành riêng cho các bạn học viên có niềm đam mê với các món ăn châu Âu nổi tiếng, muốn tìm hiểu về văn hóa đồ ăn nhanh của phương Tây." , 750000, "Từ 5 - 12 " ," tầng 5 – 142 Lê Duẩn, Hà Nội ",1,6,18,2,current_timestamp()),
